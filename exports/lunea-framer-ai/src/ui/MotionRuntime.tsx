...
export type InteractionDefinitionMap = Record<string, any>;
...
function createFrozenAnimation(
  ...
  try {
    ...
    const animation = element.animate(waapiKeyframes([frame, frame]), { duration: 1, fill: "both" });
    animation.pause();
...
export function MotionRuntime({
  ...
  useLayoutEffect(() => {
    ...
    for (const interaction of Object.values((interactions || {}) as Record<string, any>)) {
              ...
              for (const element of elements) {
                ...
                for (const property of Object.keys(target.closed)) {
                  ...
                  const group = groups.get(key) ?? {
                    closed: {} as Record<string, any>,
                    open: {} as Record<string, any>,
                    duration,
                    delay,
                    easing,
                  };
