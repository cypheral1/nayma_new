...
import { ProductsGentleCreamCleanser1 } from "@/components/ProductsGentleCreamCleanser1";
import { siteAssetUrl, siteJsonLd, siteUrl } from "@/config/site";
import { MotionRuntime } from "@/ui/MotionRuntime";
import {
  motionDefinitions,
  interactionDefinitions,
} from "@/components/ProductsGentleCreamCleanser1/ProductsGentleCreamCleanser1/ProductsGentleCreamCleanser1.motion";
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: siteUrl("/products/gentle-cream-cleanser-1") },
  openGraph: {
    title: "Gentle Cream Cleanser - Nayma - Everyday Care. Timeless Confidence",
    description:
      "Advanced skincare made simple. Nayma harnesses science and nature to create effective formulas that repair, protect, and elevate your skin.",
    url: siteUrl("/products/gentle-cream-cleanser-1"),
